...
// Ensure standalone test mode without port binding conflicts
process.env.NODE_ENV = 'test';

console.log('[TEST_INIT] Initializing isolated testing environment for IFRS ISSB schema verification...');

const { default: app } = await import('./server/index.js');

// Launch isolated local server on an unencumbered port
